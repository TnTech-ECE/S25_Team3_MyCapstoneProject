...
- With the additional layer of surveillance, public safety will be improved by the tracking and handling of non-authorized drone traffic on campus.
- The drone tracker will also address privacy issues involving drones with cameras.
...
- There may also be a slight increase in financial costs to support the maintenance of the web server, website, and physical hardware required for this project.
