...
The system allows campus police to manage drone authorizations directly through the website. By clicking on a drone, an officer can mark it as either authorized or unauthorized. Authorized drones are displayed in green, unauthorized drones in red, and newly detected drones in purple until an officer assigns their authorization status, providing an intuitive visual cue for immediate attention.
...
Throughout the design and implementation process, the system adhered to the legal, ethical, and professional constraints identified at the project's outset. All features were implemented in compliance with U.S. and Tennessee laws governing Remote ID handling and privacy considerations.
