...
The Raspberry Pi 5 has sufficient processing power to handle telemetry data incoming from several remote transceivers at the required sample rate. It is equipped with a 2.4 GHz quad-core ARM Cortex-A76 CPU. Each of the four cores can independently execute threads or processes, enabling the system to manage multiple simultaneous TCP connections. The A76 is built to process instructions and tasks in parallel much more effectively. [9] This experiment tests the amount of inserts mySQL can receive. Multiple inserts were given to mySQL at a time and concluded it can handle 28,000 inserts per second. [10] This project uses real-time data that is logged into a mySQL database. [11] Using a Raspberry Pi 4 and mySQL, this experiemnt came to the conclusion that the Pi is able to run over 1000 queries per second. For this project, the Pi needs to handle 14 inserts per drone per second. If there were 50 drones, the Pi and mySQL would handle 700 inserts per second which is well under the limit. Based on the research and the project needs, the Raspberry Pi 5 would be the best. 
...
[6] “Telemetry - DJI Onboard SDK Documentation,” Dji.com, 2017. https://developer.dji.com/onboard-sdk/documentation/guides/component-guide-telemetry.html (Accessed April 28, 2025).

[7] “RemoteID Final Rule | Federal Aviation Administration,” Faa.gov, 2021. https://www.faa.gov/newsroom/remoteid-final-rule (Accessed April 28, 2025).

[8] A. Frumusanu, “Arm’s Cortex-A76 CPU Unveiled: Taking Aim at the Top for 7nm,” www.anandtech.com. https://www.anandtech.com/show/12785/arm-cortex-a76-cpu-unveiled-7nm-powerhouse (Accessed April 28, 2025).

[9] Object, “Improve MySQL Insert Performance | kvz.io,” kvz.io, Oct. 24, 2024. https://kvz.io/blog/improve-mysql-insert-performance.html (Accessed April 30, 2025).

[10] sidharthmohannair, “GitHub - sidharthmohannair/Thermal-Imaging-Drone-SAR: A thermal imaging drone integrated with real-time object detection and location tracking system for efficient search and rescue operations.,” GitHub, 2024. https://github.com/sidharthmohannair/Thermal-Imaging-Drone-SAR/tree/main (Accessed April 30, 2025).

[11] B. Dicken, “MySQL on a Raspberry Pi | Benjamin Dicken,” Benjdd.com, Jun. 20, 2024. https://benjdd.com/posts/mysql-on-a-raspberry-pi/ (Accessed Apr. 30, 2025).
